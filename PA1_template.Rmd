...
Unzip the data and read it into R.
...
Process the data to make it suitable for further analysis. Parse the date string as a Date object.
...
Summarize the data to get steps per day. 
...
Plot histogram to see how the steps per day have evolved over time.
